...
export default function ContactForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    // TODO: Connect to your form handler (e.g. Formspree, Sanity, etc.)
  ...
  return (
    <section id="contact" className="bg-ecm-green py-20">
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16">
        {/* Left: Contact Info */}
        <div>
          <h2 className="text-ecm-lime font-barlow font-bold text-3xl mb-8">
            GET IN TOUCH
          </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="bg-ecm-lime text-ecm-green font-barlow font-semibold px-10 py-3 rounded-full hover:bg-ecm-lime-hover transition-colors"
          >
            Send
          </button>
        </form>
